        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 sm:col-span-3">
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-xl font-bold">Asliddin Malikov</h1>
                        <p className="text-gray-700">AI Engineer</p>
                        <div className="mt-6 flex flex-wrap gap-4 justify-center">
                           
                            <a href={cv} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">Resume</a>
                        </div>
                    </div>
            ...
            <div className="col-span-4 sm:col-span-9">
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <p className="text-gray-700">Highly motivated and technically adept individual with experience in deep learning, machine learning, and image processing seeking a challenging and rewarding role at Uzcosmos. Eager to contribute to the agency's mission of advancing aerospace research and exploration through innovative applications of these cutting-edge technologies. Possess strong programming skills in Python along with proficiency in popular deep learning frameworks like TensorFlow and PyTorch. Passionate about solving complex problems and bringing new ideas to life through the power of artificial intelligence.
                    </p>
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between flex-wrap gap-2 w-full">
                            <span className="text-gray-700 font-bold">Education</span>
                            <p>
                        ...
                        <p className="mt-2">
                        Bachelor, Tashkent University of Information Technologies, Tashkent
                        </p>
                    </div>
                    <div className="mb-6">
                        <div className="flex justify-between flex-wrap gap-2 w-full">
                            ...
                            <p>
                                <span className="text-gray-700 mr-2"></span>
                                <span className="text-gray-700 font-bold">English</span>
                            </p>
                        </div>
                        <div className="mt-2 text-center">
                           <h1 className="my-3 font-semibold">C1 Degree From IELTS </h1>
                           <img src={c1} alt="" />
                        </div>
                    </div>
                    <div className="mb-6">
                        <div className="flex justify-between flex-wrap gap-2 w-full">
                            <span className="text-gray-700 font-bold">Machine Learning</span>
                            <p>
                                <span className="text-gray-700 mr-2 font-bold">Coursera</span>
                                <span className="text-gray-700">Online</span>
                            </p>
                        </div>
                        <p className="mt-2">
                            <img src={certificate} alt="" />
                            <h1 className="my-6">Verify this certificate at: <a className="text-blue-500 hover:font-bold" href="https://coursera.org/verify/specialization/CYRTBRLJKZXR">Verify certificate </a> </h1>
                        </p>
                    </div>
                </div>
            </div>
